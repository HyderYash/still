-- Image Marks Database Schema Setup
...
CREATE INDEX IF NOT EXISTS idx_image_marks_image_id ON image_marks(image_id);
CREATE INDEX IF NOT EXISTS idx_image_marks_project_id ON image_marks(project_id);
CREATE INDEX IF NOT EXISTS idx_image_marks_author_id ON image_marks(author_id);
CREATE INDEX IF NOT EXISTS idx_image_marks_created_at ON image_marks(created_at);
...
-- INSERT INTO image_marks (image_id, project_id, author_id, author_name, mark_type, x_coordinate, y_coordinate, radius, color, comment)
-- VALUES 
--     ('sample-image-id', 'sample-project-id', 'sample-user-id', 'John Doe', 'circle', 100, 100, 50, 'blue', 'This area needs attention'),
--     ('sample-image-id', 'sample-project-id', 'sample-user-id', 'John Doe', 'rectangle', 200, 200, NULL, 'red', 'Good composition here');
